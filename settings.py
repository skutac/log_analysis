...
DATABASES = {
    'default': {
        ...
        'NAME': "logy",                      # Or path to database file if using sqlite3.
    ...
    'psh_db': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'psh_db',                      # Or path to database file if using sqlite3.
        'USER': config.DB_USER,                      # Not used with sqlite3.
        'PASSWORD': config.DB_PASSWORD,                  # Not used with sqlite3.
        'HOST': '',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
...
SECRET_KEY = ')w^8_g-i-+msy9s82p0ev(b0bt6z3)4!(f1(qn-*sjtrg#q-*-'
